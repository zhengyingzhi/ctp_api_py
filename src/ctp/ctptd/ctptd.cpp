...
{
    Task task = Task();
    task.task_name = ONRSPBATCHOORDERACTION;
...
void TdApi::processTask()
{
	while (1)
	{
		...
		{
			this->processOnRspQryMMInstrumentCommissionRate(task);
			break;
		}
		case ONRSPQRYMMOPTIONINSTRCOMMRATE:
		{
			this->processOnRspQryMMOptionInstrCommRate(task);
			break;
		}
		case ONRSPQRYINSTRUMENTORDERCOMMRATE:
		{
			this->processOnRspQryInstrumentOrderCommRate(task);
			break;
		}
		case ONRSPQRYSECAGENTTRADINGACCOUNT:
		{
			this->processOnRspQrySecAgentTradingAccount(task);
			break;
		}
		case ONRSPQRYSECAGENTCHECKMODE:
		{
			this->processOnRspQrySecAgentCheckMode(task);
			break;
		}
...
void TdApi::processOnRspQryMMInstrumentCommissionRate(Task task)
{
    // TODO
}
void TdApi::processOnRspQryMMOptionInstrCommRate(Task task)
{
    // TODO
}
void TdApi::processOnRspQryInstrumentOrderCommRate(Task task)
{
    // TODO
}
void TdApi::processOnRspQrySecAgentTradingAccount(Task task)
{
    // TODO
}
void TdApi::processOnRspQrySecAgentCheckMode(Task task)
{
    // TODO
}
