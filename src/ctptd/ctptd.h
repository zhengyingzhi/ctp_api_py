...
#define ONRSPBATCHOORDERACTION                  114
#define ONRSPOPTIONSELFCLOSEINSERT              115
#define ONRSPOPTIONSELFCLOSEACTION              116
#define ONRSPQRYMMINSTRUMENTCOMMISSIONRATE      117
#define ONRSPQRYMMOPTIONINSTRCOMMRATE           118
#define ONRSPQRYINSTRUMENTORDERCOMMRATE         119
#define ONRSPQRYSECAGENTTRADINGACCOUNT          120
#define ONRSPQRYSECAGENTCHECKMODE               121
#define ONRSPQRYOPTIONSELFCLOSE                 122
#define ONRSPQRYINVESTUNIT                      123
#define ONRTNBULLETIN                           124
#define ONERRRTNBATCHORDERACTION                125
#define ONRTNOPTIONSELFCLOSE                    126
#define ONERRRTNOPTIONSELFCLOSEINSERT           127
#define ONERRRTNOPTIONSELFCLOSEACTION           128
...
public:
	...
	void processOnRspQryMMInstrumentCommissionRate(Task task);
	void processOnRspQryMMOptionInstrCommRate(Task task);
	void processOnRspQryInstrumentOrderCommRate(Task task);
	void processOnRspQrySecAgentTradingAccount(Task task);
	void processOnRspQrySecAgentCheckMode(Task task);
