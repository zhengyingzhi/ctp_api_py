...
void KDMdApi::create_md_api(string pszFlowPath)
{
    (void)pszFlowPath;
    this->api = KDMdCreate();
...
PYBIND11_MODULE(kdmd, m)
{
    ...
    mdapi
        .def(init<>())
        .def("create_md_api", &KDMdApi::create_md_api, pybind11::arg("pszFlowPath") = "", "KDMdCreate")
        .def("Create", &KDMdApi::create_md_api, pybind11::arg("pszFlowPath") = "", "KDMdCreate")
        .def("get_api_version", &KDMdApi::get_api_version, "KDMdGetVersion")
        .def("GetVersion", &KDMdApi::get_api_version, "KDMdGetVersion")
        .def("release", &KDMdApi::release, "KDMdRelease")
        .def("init", &KDMdApi::init, "KDMdInit")
        .def("exit", &KDMdApi::exit)
        .def("set_option", &KDMdApi::set_option, "KDMdSetOption")
        .def("SetOption", &KDMdApi::set_option, "KDMdSetOption")
        .def("get_option", &KDMdApi::get_option, "KDMdGetOption")
        .def("GetOption", &KDMdApi::get_option, "KDMdGetOption")
        .def("register_front", &KDMdApi::register_front, "KDMdRegisterServer")
        .def("RegisterServer", &KDMdApi::register_front, "KDMdRegisterServer")
        .def("subscribe_market_data", &KDMdApi::subscribe_market_data, "KDMdSubscribe")
        .def("Subscribe", &KDMdApi::subscribe_market_data, "KDMdSubscribe")
        .def("unsubscribe_market_data", &KDMdApi::unsubscribe_market_data, "KDMdUnSubscribe")
        .def("UnSubscribe", &KDMdApi::unsubscribe_market_data, "KDMdUnSubscribe")
        .def("unsubscribe_all", &KDMdApi::unsubscribe_all, "KDMdUnSubscribeAll")
        .def("UnSubscribeAll", &KDMdApi::unsubscribe_all, "KDMdUnSubscribeAll")
        .def("req_qry_data", &KDMdApi::req_qry_data, "KDMdReqQryData")
        .def("ReqQryData", &KDMdApi::req_qry_data, "KDMdReqQryData")
        .def("req_qry_data2", &KDMdApi::req_qry_data2, pybind11::return_value_policy::reference)
        .def("req_get_data", &KDMdApi::req_get_data, "KDMdReqGetData")
        .def("ReqGetData", &KDMdApi::req_get_data, "KDMdReqGetData")
        .def("req_get_data2", &KDMdApi::req_get_data2, pybind11::return_value_policy::reference)
        .def("req_user_login", &KDMdApi::req_user_login, "KDMdReqLogin")
        .def("ReqLogin", &KDMdApi::req_user_login, "KDMdReqLogin")
        .def("req_user_logout", &KDMdApi::req_user_logout, "KDMdReqLogout")
        .def("ReqLogout", &KDMdApi::req_user_logout, "KDMdReqLogout")
